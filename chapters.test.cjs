...
test('first wins unlock chapters and bonuses exactly once',()=>{
 ...
 assert.deepEqual(P.rewardMatch(save,true,5,'jax'),{earned:200,bonus:80,first:true});
 ...
 assert.deepEqual(P.rewardMatch(save,true,5,'mira'),{earned:220,bonus:100,first:true});
